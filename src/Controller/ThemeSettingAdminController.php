...
class ThemeSettingAdminController extends CRUDController
{
    ...
    public function __construct(EntityManagerInterface $em, ThemeSettingValidator $themeSettingValidator, TemplateRegistryInterface $templateRegistry, AdminExporter $adminExporter = null)
    {
        $this->em = $em;
    ...
    public function listAction(Request $request): Response
    {
        ...
        return $this->renderWithExtraParams($template, [
            ...
            'export_formats' => $this->adminExporter ? $this->adminExporter->getAvailableFormats($this->admin) : $this->admin->getExportFormats(),
        ]);
    }
        ...
        try {
            foreach ($data['form'] as $field_name => $field_value) {
                ...
                if($getMasterSetting != null) {
                    ...
                    if ($field_name == 'font_family' && $field_value != "") {
