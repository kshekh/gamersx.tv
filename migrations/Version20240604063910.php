 ...
 */
final class Version20240604063910 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE home_row (id INT AUTO_INCREMENT NOT NULL, partner_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, sort_index SMALLINT DEFAULT NULL, layout VARCHAR(32) NOT NULL, options JSON DEFAULT NULL, is_published TINYINT(1) NOT NULL, is_glow_styling TINYINT(1) DEFAULT 0 NOT NULL, is_corner_cut TINYINT(1) DEFAULT 0 NOT NULL, timezone VARCHAR(255) NOT NULL, is_published_start DATETIME DEFAULT NULL, is_published_end DATETIME DEFAULT NULL, on_gamers_xtv TINYINT(1) DEFAULT 0 NOT NULL, row_padding_top INT DEFAULT 0, row_padding_bottom INT DEFAULT 0, INDEX IDX_16758CEF9393F8FE (partner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
