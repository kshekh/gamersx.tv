  ...
  <div>
    ...
    >
      ...
      <div
        ...
        ref="channelBox"
        style="width: 100%"
        class="flex custom-smooth-scroll pt-5 xl:pt-9 pb-7 md:pb-6 xl:pb-12 pl-4"
      >
        <div
          ref="channelDivs"
          v-for="(channel, index) in displayChannels"
          :key="index"
          class="flex items-center shrink-0 mr-3 md:mr-2 xl:mr-4 w-64 md:w-48 lg:w-60 xl:w-337 h-48 md:h-27 lg:h-40 xl:h-60"
