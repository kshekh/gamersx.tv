<template>
  ...
  <div class="text-white">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/DgGHSMGC2EU?si=VOkTJrRL-qwBDMn7" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
  </div>
</template>
<script>
