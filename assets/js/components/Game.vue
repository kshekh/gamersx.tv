    ...
    <div class="flex-col">
      ...
      <div class="flex flex-row align-items-center justify-center space-x-4">
        ...
        <div v-bind:style="backgroundStyle('artBg')" class="w-auto p-4">
          <a
            :href="'https://www.twitch.tv/directory/game/' + info.name"
            target="_twitch"
          >
            ...
            <div>
              ...
              <span
                v-if="popular"
                class="text-gray-800 bg-red-400 p-1 rounded-sm"
              >
                {{ info.streamers }} Live
              </span>
              ...
              <span class="font-xl p-2"> {{ info.viewers }} watching </span>
            </div>
          </a>
        </div>
